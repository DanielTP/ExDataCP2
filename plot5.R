...
data_pm2 <- tbl_df(data_pm[data_pm$fips == 24510,c(1,2,4,6)])
data_sc2 <- tbl_df(data_sc[,c(1,4)])

# Getting Vehicles-related SCC and Calculate total emissions
...
# Plot
png("plot5.png")
plot(data_plot3$Emissions, type = "l", xlab = "Year", ylab = "Total Emissions from Motor Vehicles Sources in Baltimore City (tons)", xaxt = "n")
